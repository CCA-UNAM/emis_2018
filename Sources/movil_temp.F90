...
character(len=14),dimension(nf) :: casn
 ...
 data casn /'TMCO__2018.csv','TMNH3_2018.csv','TMNO2_2018.csv', &
            'TMNO__2018.csv','TMSO2_2018.csv','TMCN__2018.csv', &
            'TMCO2_2018.csv','TMCH4_2018.csv','TMPM102018.csv', &
            'TMPM2_2018.csv','TMCOV_2018.csv'/
