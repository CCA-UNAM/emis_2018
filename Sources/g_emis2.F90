...
subroutine setup_mecha
    ...
    case("ghg")
        ...
        fnameA=(/'TACO2_2018.csv   ','GHG_CH4_A.txt    ','TACH4_2018.csv   '/)
        fnameM=(/'TMCO2_2018.csv   ','GHG_CH4_M.txt    ','TMCH4_2018.csv   '/)
    ...
    fnameA=(/'TACO__2018.csv   '  ,&
    'TANH3_2018.csv   ','TANOx_2018.csv   ','TANOx_2018.csv   ','TASO2_2018.csv   ',&
    ...
    'TACO2_2018.csv   ','TAPM102018.csv   ','TAPM2_2018.csv   ',&
    'GSO4_A.txt       ','PNO3_A.txt       ','OTHE_A.txt       ','POA_A.txt        ',&
    'PEC_A.txt        ','TACH4_2018.csv   ','TACN__2018.csv   '/)
    fnameM=(/'TMCO__2018.csv   ',&
    'TMNH3_2018.csv   ','TMNO__2018.csv   ','TMNO2_2018.csv   ','TMSO2_2018.csv   ',&
    ...
    'TMCO2_2018.csv   ','TMPM102018.csv   ','TMPM2_2018.csv   ',&
    'GSO4_M.txt       ','PNO3_M.txt       ','OTHE_M.txt       ','POA_M.txt        ',&
    'PEC_M.txt        ','TMCH4_2018.csv   ','TMCN__2018.csv   '/)
    fnameP=(/'T_ANNCO.csv      ',&
    ...
    fnameA=(/'TACO__2018.csv   ','TANOx_2018.csv   ','TANOx_2018.csv   ',&
    'TANH3_2018.csv   ','TASO2_2018.csv   ',&
    ...
    'PEC_A.txt        ','TACH4_2018.csv   ','TACN__2018.csv   '/)
    fnameM=(/'TMCO__2018.csv   ',&
    'TMNO__2018.csv   ','TMNO2_2018.csv   ','TMNH3_2018.csv   ','TMSO2_2018.csv   ',&
    ...
    fnameA=(/'TACO__2018.csv   ','TANH3_2018.csv   ','TANOx_2018.csv   ','TANOx_2018.csv   ',&
    'TASO2_2018.csv   ','RACM2_CH4_A.txt  ','RACM2_ETH_A.txt  ','RACM2_HC3_A.txt  ',&
    ...
    'RACM2_MOH_A.txt  ','TACO2_2018.csv   ','TAPM102018.csv   ','TAPM2_2018.csv   ',&
    'GSO4_A.txt       ','PNO3_A.txt       ','OTHE_A.txt       ','POA_A.txt        ',&
    'PEC_A.txt        ','TACH4_2018.csv   ','TACN__2018.csv   '/)
    fnameM=(/'TMCO__2018.csv   ','TMNH3_2018.csv   ','TMNO__2018.csv   ','TMNO2_2018.csv   ',&
    'TMSO2_2018.csv   ','RACM2_CH4_M.txt  ','RACM2_ETH_M.txt  ','RACM2_HC3_M.txt  ',&
    ...
    'RACM2_MOH_M.txt  ','TMCO2_2018.csv   ','TMPM102018.csv   ','TMPM2_2018.csv   ', &
    'GSO4_M.txt       ','PNO3_M.txt       ','OTHE_M.txt       ','POA_M.txt        ',&
    'PEC_M.txt        ','TMCH4_2018.csv   ','TMCN__2018.csv   '/)
    ...
    fnameA=['TACO__2018.csv   ',&
     ...
     'RADM-2_XYL_A.txt ','TACO2_2018.csv   ','TAPM102018.csv   ','TAPM2_2018.csv   ', &
     'GSO4_A.txt       ','PNO3_A.txt       ','OTHE_M.txt       ','POA_A.txt        ',&
     'PEC_A.txt        ','TACH4_2018.csv   ','TACN__2018.csv   ']
    fnameM=['TMCO__2018.csv   ',&
     'TMNH3_2018.csv   ','TMNO__2018.csv   ','TMNO2_2018.csv   ','TMSO2_2018.csv   ',&
     ...
     'RADM-2_XYL_M.txt ','TMCO2_2018.csv   ','TMPM102018.csv   ','TMPM2_2018.csv   ', &
     'GSO4_M.txt       ','PNO3_M.txt       ','OTHE_M.txt       ','POA_M.txt        ',&
     'PEC_M.txt        ','TMCH4_2018.csv   ','TMCN__2018.csv   ']
    fnameP=['T_ANNCO.csv      ',&
     'T_ANNNH3.csv     ','T_ANNNOX.csv     ','T_ANNNOX.csv     ','T_ANNSO2.csv     ',&
    ...
    'Organic Carbon  ','Elemental Carbon']
    fnameA=(/'TACO__2018.csv    ',&
    'TANOx_2018.csv    ','TANOx_2018.csv    ','TANH3_2018.csv    ','TASO2_2018.csv    ',&
    ...
    'TACO2_2018.csv    ','TAPM102018.csv    ','TAPM2_2018.csv    ','GSO4_A.txt        ',&
    'PNO3_A.txt        ','OTHE_M.txt        ','POA_A.txt         ','PEC_A.txt         ',&
    'TACH4_2018.csv    ','TACN__2018.csv    '/)
    fnameM =(/'TMCO__2018.csv    ',&
    'TMNO__2018.csv    ','TMNO2_2018.csv    ','TMNH3_2018.csv    ','TMSO2_2018.csv    ',&
    ...
    'TMCO2_2018.csv    ','TMPM102018.csv    ','TMPM2_2018.csv    ','GSO4_M.txt        ',&
    'PNO3_M.txt        ','OTHE_M.txt        ','POA_M.txt         ','PEC_M.txt         ',&
    'TMCH4_2018.csv    ','TMCN__2018.csv    '/)
    fnameP=(/'T_ANNCO.csv       ',&
    'T_ANNNOX.csv      ','T_ANNNOX.csv      ','T_ANNNH3.csv      ','T_ANNSO2.csv      ',&
  ...
  fnameA=['TACO__2018.csv    ',&
      ...
      'TACH4_2018.csv    ','TACN__2018.csv    ']
fnameM =(/'TMCO__2018.csv    ',&
          'TMNO__2018.csv    ','TMNO__2018.csv    ','TMNH3_2018.csv    ','TMSO2_2018.csv    ',&
