...
!
! ifort g_radm_2018nh.f90 -O2 -axAVX -lnetcdff -L$NETCDF/lib -I$NETCDF/include -o radm2h.exe
!
!
...
subroutine lee
	...
	data fnameA /'TACO__2018.csv','TANH3_2018.csv','TANOx_2018.csv','TANOx_2018.csv','TASO2_2018.csv',&
	...
	data fnameM /'TMCO__2018.csv','TMNH3_2018.csv','TMNO_2018.csv','TMNO2_2018.csv','TMSO2_2018.csv',&
